 ...
 *
 */
@Service("italianSerieAService")
public class ItalianSerieAServiceImpl implements CrawlerService {

    
    private static final Logger log = Logger.getLogger(ItalianSerieAServiceImpl.class);
