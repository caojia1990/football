...
import com.eastng.football.web.view.match.WqueryScoreBoardResultVO;
...
public class MatchController {
     ...
     * @throws FootBallBizException
     */
    @RequestMapping(value="queryScoreBoard" ,method = RequestMethod.POST)
    @ResponseBody
    public List<WqueryScoreBoardResultVO> queryScoreBoard(@RequestParam(value="seasonNo" ,required=false)String seasonNo){
    ...
    @RequestMapping(value="updateScoreBoard" ,method = RequestMethod.POST)
    @ResponseBody
